<nav class="mb-4 bg-white shadow navbar navbar-expand navbar-light topbar static-top">
	...
	<ul class="ml-auto navbar-nav">
		...
		<li class="mx-1 nav-item p-3">
			<a href="https://www.youtube.com/@ch4nn780" target="_blank" title="Subscribe now"> <i class="fab fa-youtube text-danger"></i>
			</a>
		</li>
		<li class="mx-1 nav-item p-3">
			<a href="https://www.facebook.com/profile.php?id=100091475912672" target="_blank" title="be fans"> <i class="fab fa-facebook"></i>
			</a>
		</li>
		<li class="mx-1 nav-item p-3">
